...
var AsyncCache, GitHub, branch, contents, mori, p, repo, request, user;
...
contents = new AsyncCache({
  ...
  load: function(key, cb) {
    ...
    return request.get(("https://api.github.com/repos/" + user + "/" + repo + "/contents/") + key).set('Accept', 'application/vnd.github.v3+json').set('Content-type', 'application/json').query({
      'ref': branch
    }).end(function(res) {
      var o;
      o = res.body;
...
GitHub = (function() {
  ...
  GitHub.prototype.fetch = function(path, cb) {
    return contents.get(path, cb);
  };

  GitHub.prototype.save = function(path, content, cb) {
    var req, sha, status;
    p = path.split('?');
    path = p[0];
    sha = p[1];
    status = sha ? 'updated ' : 'created ';
    req = request.put("https://api.github.com/repos/" + user + "/" + repo + "/contents/" + path).set('Accept', 'application/vnd.github.v3+json').set('Content-type', 'application/json').set('Authorization', atob(user + ':' + this.password)).query('branch', branch).query('message', status + path);
    if (sha) {
      req.query('sha', sha);
    }
  ...
  GitHub.prototype.setPass = function(password) {
...
},{"async-cache":3,"mori":6,"superagent":142}],2:[function(require,module,exports){
var DocTree, Edit, GitHub, Main, React, a, b, body, button, dd, div, dl, dt, fieldset, form, gh, h1, h2, h3, h4, h5, h6, head, html, i, img, input, label, legend, li, link, meta, mori, p, script, small, span, table, tbody, td, textarea, tfoot, th, thead, title, tr, ul, _ref;
...
Main = React.createClass({
  ...
  startEditing: function(path, content) {
...
DocTree = React.createClass({
  ...
  componentDidMount: function() {
    return gh.fetch(this.props.key, (function(_this) {
      return function(children) {
        var file, filename, kind, _i, _len;
        if (children.length) {
          for (_i = 0, _len = children.length; _i < _len; _i++) {
            file = children[_i];
            if (file.type === 'dir' && file.path !== 'assets') {
              _this.state.children = mori.conj(_this.state.children, file);
            } else if (file.type === 'file') {
              filename = mori.last(mori.filter(mori.identity, file.path.split('/')));
              if (mori.has_key(_this.contentFilenames, filename)) {
                kind = mori.first(filename.split('.'));
                _this.state.content = mori.assoc(_this.state.content, kind, file);
              }
            }
          }
  ...
  editDocument: function(e) {
    e.preventDefault();
    return this.props.onSelect(this.props.key, this.state.content);
  },
  render: function() {
    return li({}, mori.count(this.state.children) ? a({
      href: '#',
      onClick: this.openTree
    }, this.state.opened ? '⇡' : '⇣') : void 0, a({
      href: '#',
      onClick: this.editDocument
    }, '/' + mori.last(mori.filter(mori.identity, this.props.key.split('/')))), this.state.opened ? ul({}, mori.into_array(mori.map(((function(_this) {
    ...
    })(this)), this.state.children))) : void 0);
  }
});
...
Edit = React.createClass({
  ...
  componentDidUpdate: function(prevProps) {
    var dataPath, textPath;
    if (prevProps.path !== this.props.path) {
      textPath = (mori.get(this.props.content, 'text') || {}).path;
      if (textPath) {
        gh.fetch(textPath, (function(_this) {
          return function(file) {
        ...
        this.setState({
          text: {
            path: this.props.path + '/text.md',
            content: ''
          }
        });
      }
      dataPath = (mori.get(this.props.content, 'data') || {}).path;
      if (dataPath) {
        return gh.fetch(dataPath, (function(_this) {
          return function(file) {
            return _this.setState({
              data: {
                path: file.path + '?' + file.sha,
        ...
        return this.setState({
          data: {
            path: this.props.path + '/data.yaml',
            content: ''
          }
        });
      }
...
},{"./github.coffee":1,"mori":6,"react":141}],3:[function(require,module,exports){
(function (process){
...
},{"_process":5,"lru-cache":4}],4:[function(require,module,exports){
...
},{"./invariant":118,"_process":5}],15:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./DOMProperty":14,"./escapeTextForBrowser":104,"./memoizeStringOnly":126,"./warning":140,"_process":5}],16:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ExecutionEnvironment":26,"./createNodesFromMarkup":99,"./emptyFunction":102,"./getMarkupWrap":111,"./invariant":118,"_process":5}],17:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyFunction":102,"_process":5}],22:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventPluginRegistry":23,"./EventPluginUtils":24,"./ExecutionEnvironment":26,"./accumulate":93,"./forEachAccumulated":107,"./invariant":118,"./isEventSupported":119,"./monitorCodeUse":131,"_process":5}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./invariant":118,"_process":5}],24:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventConstants":20,"./invariant":118,"_process":5}],25:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventConstants":20,"./EventPluginHub":22,"./accumulate":93,"./forEachAccumulated":107,"_process":5}],26:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactPropTypes":70,"./invariant":118,"./warning":140,"_process":5}],28:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":118,"_process":5}],30:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactMount":61,"./invariant":118,"_process":5}],32:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./PooledClass":29,"./invariant":118,"./traverseAllChildren":139,"_process":5}],33:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactCurrentOwner":37,"./ReactOwner":65,"./ReactUpdates":77,"./invariant":118,"./keyMirror":124,"./merge":127,"./monitorCodeUse":131,"_process":5}],34:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactDOMIDOperations":42,"./ReactMarkupChecksum":60,"./ReactMount":61,"./ReactPerf":66,"./ReactReconcileTransaction":72,"./getReactRootElementInContainer":113,"./invariant":118,"_process":5}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./CSSPropertyOperations":9,"./DOMProperty":14,"./DOMPropertyOperations":15,"./ReactBrowserComponentMixin":31,"./ReactComponent":33,"./ReactEventEmitter":54,"./ReactMount":61,"./ReactMultiChild":63,"./ReactPerf":66,"./escapeTextForBrowser":104,"./invariant":118,"./keyOf":125,"./merge":127,"./mixInto":130,"_process":5}],41:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./CSSPropertyOperations":9,"./DOMChildrenOperations":13,"./DOMPropertyOperations":15,"./ReactMount":61,"./ReactPerf":66,"./invariant":118,"_process":5}],43:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./AutoFocusMixin":7,"./DOMPropertyOperations":15,"./LinkedValueUtils":27,"./ReactBrowserComponentMixin":31,"./ReactCompositeComponent":35,"./ReactDOM":38,"./ReactMount":61,"./invariant":118,"./merge":127,"_process":5}],45:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactBrowserComponentMixin":31,"./ReactCompositeComponent":35,"./ReactDOM":38,"./warning":140,"_process":5}],46:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./AutoFocusMixin":7,"./LinkedValueUtils":27,"./ReactBrowserComponentMixin":31,"./ReactCompositeComponent":35,"./ReactDOM":38,"./invariant":118,"./merge":127,"_process":5}],47:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./AutoFocusMixin":7,"./DOMPropertyOperations":15,"./LinkedValueUtils":27,"./ReactBrowserComponentMixin":31,"./ReactCompositeComponent":35,"./ReactDOM":38,"./invariant":118,"./merge":127,"./warning":140,"_process":5}],49:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":20,"./EventListener":21,"./EventPluginHub":22,"./EventPluginRegistry":23,"./ExecutionEnvironment":26,"./ReactEventEmitterMixin":55,"./ViewportMetrics":92,"./invariant":118,"./isEventSupported":119,"./merge":127,"_process":5}],55:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactRootIndex":73,"./invariant":118,"_process":5}],60:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./DOMProperty":14,"./ReactEventEmitter":54,"./ReactInstanceHandles":59,"./ReactPerf":66,"./containsNode":95,"./getReactRootElementInContainer":113,"./instantiateReactComponent":117,"./invariant":118,"./shouldUpdateReactComponent":137,"_process":5}],62:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyObject":103,"./invariant":118,"_process":5}],66:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./emptyFunction":102,"./invariant":118,"./joinClasses":123,"./merge":127,"_process":5}],68:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactComponent":33,"./ReactPropTypeLocationNames":68,"./createObjectFrom":100,"./warning":140,"_process":5}],71:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":33,"./ReactInstanceHandles":59,"./ReactMarkupChecksum":60,"./ReactServerRenderingTransaction":75,"./instantiateReactComponent":117,"./invariant":118,"_process":5}],75:[function(require,module,exports){
/**
...
},{"./ReactPerf":66,"./invariant":118,"_process":5}],78:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":20,"./EventPluginUtils":24,"./EventPropagators":25,"./SyntheticClipboardEvent":81,"./SyntheticDragEvent":83,"./SyntheticEvent":84,"./SyntheticFocusEvent":85,"./SyntheticKeyboardEvent":86,"./SyntheticMouseEvent":87,"./SyntheticTouchEvent":88,"./SyntheticUIEvent":89,"./SyntheticWheelEvent":90,"./invariant":118,"./keyOf":125,"_process":5}],81:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":118,"_process":5}],92:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":118,"_process":5}],94:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactCompositeComponent":35,"./invariant":118,"_process":5}],99:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ExecutionEnvironment":26,"./createArrayFrom":97,"./getMarkupWrap":111,"./invariant":118,"_process":5}],100:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"_process":5}],101:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"_process":5}],104:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":118,"./traverseAllChildren":139,"_process":5}],106:[function(require,module,exports){
/**
 * Copyright 2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ExecutionEnvironment":26,"./invariant":118,"_process":5}],112:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./warning":140,"_process":5}],118:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"_process":5}],119:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":118,"_process":5}],125:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":118,"./keyMirror":124,"_process":5}],129:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":118,"_process":5}],132:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":33,"./invariant":118,"_process":5}],135:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":118,"_process":5}],139:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactInstanceHandles":59,"./ReactTextComponent":76,"./invariant":118,"_process":5}],140:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014 Facebook, Inc.
 *
...
},{"./emptyFunction":102,"_process":5}],141:[function(require,module,exports){
