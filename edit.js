...
var DocTree, Edit, GitHub, Main, YAML, a, b, body, button, coisas, dd, div, dl, dt, fieldset, fm, form, h1, h2, h3, h4, h5, h6, head, html, i, img, input, label, legend, li, link, marked, meta, p, script, small, span, table, tbody, td, templateDefault, textarea, tfoot, th, thead, title, tr, ul, _ref;
...
DocTree = React.createClass({
  ...
  componentDidMount: function() {
    return coisas.getListing(this.props.key).then((function(_this) {
      return function(listing) {
        var data, path;
        for (path in listing) {
          data = listing[path];
          if (path.slice(-1)[0] === '/') {
            _this.state.children = mori.conj(_this.state.children, path);
          } else {
            _this.state.content = mori.assoc(_this.state.content, data.mimeType, path);
          }
        }
...
},{"./github.coffee":1,"./template-default.coffee":36,"front-matter":8,"marked":22,"yaml-js":35}],3:[function(require,module,exports){
